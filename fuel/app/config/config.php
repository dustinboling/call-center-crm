...
define("ACTION_TRANSFERED", 8);

define("ACTION_GROUP_DOCSIN", 4);
define("ACTION_GROUP_DOCSOUT", 5);

return array(
    /*
        #'default_voice_url'     => 'http://dev.crm.pinnacletaxadvisors.com/calltracking/gateway/voice',
        #'fallback_voice_url' => 'http://clientservice.pinnacletaxadvisors.com/voice_fallback.xml',
        #'default_status_callback_url' => 'http://dev.crm.pinnacletaxadvisors.com/calltracking/gateway/save_voice',
    
        //live twilio 
        'twilio' => array(
                            'account_sid' => 'ACdce6be902f7ebc743efebeee15e25e91',
                            'auth_token' => 'db7237d1b72ce04f0492f6db170311cf',
                         ),
    */
        'blank_form_folder' => '/var/www/crm/public_html/pdfs/',
        'completed_form_folder' => '/var/www/crm/forms/',
        'docs_folder' => '/var/www/crm/docs/',
        'import_file_folder' => '/var/www/crm/import/',
