<div class="tab-content">
    ...
    <?php foreach($fields as $section_id => $cfs):?>
        ...
        <?php if(in_array($section_id, array(0,25)) && uri::segment(2) == 'update'){ continue; }?>
                ...
                <?php if($f['editable']):?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php elseif($f['field_type_id'] == 8):?>
                            <input type="text" name="<?php echo $f['clean_name'];?>" class="datetimepicker" placeholder="mm/dd/yyyy hh:mm">
