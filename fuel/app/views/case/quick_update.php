        ...
        <div class="container-fluid">
            <div class="row-fluid" style="margin-top: 10px;">
                ...
                <div class="span6" style="text-align: right;">
                    ...
                    <input type="text" name="query" style="margin-bottom: 0;" placeholder="Lead ID or Phone Only"> <button class="btn btn-primary" type="submit">Search</button>
                    </form>
                ...
                <div class="span12">
                    <table class="table table-bordered case_bar table-condensed">
                        <tr>
                            ...
                            <td class="field">
                                <select name="status_id" style="margin-bottom: 0;" class="input-xlarge">
                        ...
                        <tr>
                            ...
                            <td class="field">
                                <select name="campaign_id" style="margin-bottom: 0;" class="input-xlarge">
                                    <option value=""></option>
