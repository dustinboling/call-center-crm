...
<table class="table table-bordered" style="width: 100%;">
    <tr class="case_bar">
        ...
        <td class="ttl"><button class="btn btn-primary" type="submit">Save</button></td>
    </tr>
</table>
</form>
</div>
...
$(function(){
    <?php 
    $tmp_case = $case;
    if(isset($tmp_case['federal_owed'])){ unset($tmp_case['federal_owed']); }
    if(isset($tmp_case['federal_not_filed'])){ unset($tmp_case['federal_not_filed']); }
    if(isset($tmp_case['state_owed'])){ unset($tmp_case['state_owed']); }
    if(isset($tmp_case['state_not_filed'])){ unset($tmp_case['state_not_filed']); }
    ?>
    $("#case_quickview").populate(<?php echo (isset($tmp_case)?json_encode($tmp_case):''); ?>);
