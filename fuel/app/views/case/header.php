...
<table class="table table-bordered" style="width: 100%; margin-top: 10px;">
    <tr>
        <td class="ttl" width="200">Upcoming Appointments</td>
        <td>
            
            <?php if(!empty($events)):?>
                <?php foreach($events as $e):?>
                    <a href="/event/update/<?php echo $e['id'];?>" class="btn"><?php echo $e['title'];?> - <?php echo date('m/d g:ia', strtotime($e['at']));?></a>
                <?php endforeach;?>
            <?php else:?>
                <p>No appointments or reminders scheduled</p>
            <?php endif;?>
