...
<?php if(Model_Account::getType() == 'Admin'):?>    
	...
	<div class="View Limit Amount">         
	<form action="/case/listing" method="post" id="filters">
	<input class="inputText" title="View_Amount" type="text" name="view_amount" id="view_amount" value="100" size="3"/>
	<input type="submit" name="View_Amount" class="btn btn-primary" value="Refresh View Amount">	
	</form>	
