...
<h1><?php echo ucwords(uri::segment(3));?> an Import Template</h1>

<?php echo View::Factory('system/tabs')->render();?>
<div class="r"><a id="tf_dialog" class="btn primary r">Show Available Fields</a></div>
<form action="/system/import/<?php echo uri::segment(3);?>/<?php echo uri::segment(4);?>" method="post" id="form">
    ...
    <fieldset>
        ...
        <div class="clearfix">
            <label for="update_template">Update Template</label>
            <div class="input">
                <input type="text" name="update_template" class="span6">
            </div>
        </div>    
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <textarea name="data_template" id="template_field_target" class="span8" style="height: 400px;"><?php if(isset($row['data_template'])){ echo htmlentities($row['data_template']); } ?></textarea>    
            </div>
        </div> 
