...
<h1><?php echo ucwords(uri::segment(3));?> a SMS Template</h1>

<?php echo View::Factory('system/tabs')->render();?>
<div class="r"><a id="tf_dialog" class="btn primary r">Show Available Fields</a></div>
<form action="/system/sms/<?php echo uri::segment(3);?>/<?php echo uri::segment(4);?>" method="post" id="form">
    ...
    <fieldset>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                ...
                <span class="help-block" id="message_length">160 characters remaining</span>
            </div>
...
function calculate_length(){
   ...
   if(remaining > 0){
       ...
       message = remaining + ' characters over the limit'
   }
   
   $("#message_length").html(message);
}
</script>