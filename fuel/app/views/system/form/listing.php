...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td class="c" width="20"><a href="/system/form/delete/<?php echo $f['id'];?>" onclick="return confirm('Are you sure you want to delete this form?')"><img src="/img/icons/delete.png"></a></td>
    </tr>
    <?php endforeach;?>
</table>    