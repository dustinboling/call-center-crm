    ...
    <div class="row">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td style="width: 33%;"><input type="checkbox" name="ds[]" value="vendor_lead_id"> Vendor Lead ID</td>
                <td style="width: 33%;"><input type="checkbox" name="ds[]" value="vendor_affiliate_id"> Vendor Affiliate ID</td>
            </tr>
        </table>    
