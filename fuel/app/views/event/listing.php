...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td><?php if(!empty($e['case_id'])):?><a href="/case/view/<?php echo $e['case_id'];?>"><?php echo $e['case_id'];?><?php endif;?></a></td>
        <td><?php if(isset($cases[$e['case_id']])){ echo $cases[$e['case_id']]['first_name']. ' ' . $cases[$e['case_id']]['last_name']; } ?></td>
