<h1 class="span16"><?php echo $campaign['name'];?> Calls</h1>
<?php /*
<div class="grid_24">
    <form>
        <input type="text" class="datepicker small"> to
        <input type="text" class="datepicker small"> <button class="btn primary">Find</button>
    </form>
</div>    
*/?>
<div class="span16">
    ...
    <ul class="tabs">
        ...
        <li class="active"><a href="#"><?php echo $campaign['name'];?> Calls</a></li>
    </ul>
