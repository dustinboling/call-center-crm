<div class="span16"><h1>Update Campaign</h1></div>

<form action="/calltracking/campaign/update/<?php echo $campaign['id'];?>" method="post" id="form">
...
<div class="span8">
        ...
        <fieldset>
            ...
            <div class="clearfix">
                <label for="subaccount_id">Sub Account</label>
                <div class="input">
            ...
            <div class="clearfix">
                ...
                <div class="input">
                    <select name="incoming_number" disabled="disabled">
                        <?php foreach($purchased_numbers as $n):?>
                        <option value="<?php echo $n['id'];?>"><?php echo \format::phone($n['number']);?><?php (!empty($n['label'])?print ' : '.$n['label']:'');?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
