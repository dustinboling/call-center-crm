    ...
    class Controller_Event extends Controller_Base{
        ...
        function action_add(){
            ...
            if(!empty($_POST)){
                ...
                try{
                    Model_Event::add($_POST);
                    Notify::success($_POST['title']. ' created');
                    response::redirect('/calendar/day/?d='.$date);
                }catch(Exception $e){
                    Notify::error($e);
                }
            ...
            $this->response->body = View::factory('layout', array('l' => 'event/form', 'c' => $data));
