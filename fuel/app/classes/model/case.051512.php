...
*/            
        ...
        static function fileImport($data){
            ...
            $import_file_path = '/var/www/devcrm/import/';
            ...
            while (($line = fgetcsv($handle)) !== FALSE) {
                ...
                $phones = array();
                if(isset($values['primary_phone']) && !empty($values['primary_phone'])){ $phones[] = $ds['primary_phone'] = $values['primary_phone']; }
                if(isset($values['secondary_phone']) && !empty($values['secondary_phone'])){ $phones[] = $ds['secondary_phone'] = $values['secondary_phone']; }
                if(isset($values['mobile_phone']) && !empty($values['mobile_phone'])){ $phones[] = $ds['mobile_phone'] = $values['mobile_phone']; }
