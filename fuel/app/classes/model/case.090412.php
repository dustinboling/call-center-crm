...
*/
        ...
        static function fileImport($data){
            ...
            while (($line = fgetcsv($handle)) !== FALSE) {
                ...
                $phones = array();
                if(isset($values['primary_phone']) && !empty($values['primary_phone'])){ $phones[] = $values['primary_phone']; }
                if(isset($values['secondary_phone']) && !empty($values['secondary_phone'])){ $phones[]  = $values['secondary_phone']; }
                if(isset($values['mobile_phone']) && !empty($values['mobile_phone'])){ $phones[] = $values['mobile_phone']; }
